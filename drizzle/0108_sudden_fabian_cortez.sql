...
ALTER TABLE "providers" ADD COLUMN IF NOT EXISTS "codex_image_generation_preference" varchar(10);--> statement-breakpoint
ALTER TABLE "system_settings" ADD COLUMN IF NOT EXISTS "enable_gemini_function_id_rectifier" boolean DEFAULT true NOT NULL;--> statement-breakpoint
