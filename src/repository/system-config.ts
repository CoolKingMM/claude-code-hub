...
const RECENT_COLUMN_LADDER: ReadonlyArray<{
  ...
  {
    key: "fakeStreamingProviderIds",
    column: systemSettings.fakeStreamingProviderIds,
    selectWarn:
      "system_settings 表除 fakeStreamingProviderIds 外仍有列缺失，继续回退到上一代字段集。",
    updateWarn: "system_settings 表除 fakeStreamingProviderIds 外仍有列缺失，继续降级更新。",
  },
  {
    key: "enableProviderOutputSafetyFilter",
    column: systemSettings.enableProviderOutputSafetyFilter,
    selectWarn:
      "system_settings 表除 enableProviderOutputSafetyFilter 外仍有列缺失，继续回退到上一代字段集。",
    updateWarn:
      "system_settings 表除 enableProviderOutputSafetyFilter 外仍有列缺失，继续降级更新。",
  },
  {
    key: "providerOutputSafetyFilterRules",
